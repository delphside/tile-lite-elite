...
**Unit Test Coverage Checklist** — categories a unit test suite owes on
every field and every error path they apply to, not named per project:

- Numeric fields: min, max, zero, negative
- Text fields: max size; Unicode characters display correctly
- Every error is generated
