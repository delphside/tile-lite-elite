...
names; that duplication is what the test run itself already answers.
...
every letter applies to every project — a data model has no performance
...
covered. There is no need to list them for each project.
